      ...
      <div class="w-full md:w-1/2">
        <div class="mb-10">
          <a href="#" class="flex items-center hover:scale-125 transition duration-700 ease-in-out">
            <img :src="LOGO" alt="logo" class="w-12 mr-3" />
        ...
        <div class="mb-10 md:mb-20 text-gray-600 font-light">
          ...
          <p>Mohon maaf, halaman yang anda cari tidak di temukan.</p>
        </div>
        <div class="mb-20 md:mb-0">
          <RouterLink to="/">
            <button
              class="intro-x btn py-3 px-4 text-primary border-primary dark:border-darkmode-400 mt-10 font-philosopher dark:text-[#CDA562] tracking-wide"
            >
              <ChevronLeftIcon class="inline mr-1" /> <b class="mr-2">Kembali</b>
            </button>
          </RouterLink>
        </div>
      </div>
